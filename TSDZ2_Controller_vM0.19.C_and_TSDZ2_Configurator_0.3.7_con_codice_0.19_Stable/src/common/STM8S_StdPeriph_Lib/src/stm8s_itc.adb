...
F:G$ITC_GetSoftwarePriority$0_0$0({2}DF,SC:U),Z,0,1,0,0,0
S:Lstm8s_itc.ITC_GetSoftwarePriority$IrqNum$1_0$351({1}SC:U),B,1,2
S:Lstm8s_itc.ITC_GetSoftwarePriority$Value$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_itc.ITC_GetSoftwarePriority$Mask$1_0$0({1}SC:U),B,1,-1
...
F:G$ITC_SetSoftwarePriority$0_0$0({2}DF,SV:S),Z,0,2,0,0,0
...
S:Lstm8s_itc.ITC_SetSoftwarePriority$Mask$1_0$0({1}SC:U),B,1,-2
S:Lstm8s_itc.ITC_SetSoftwarePriority$NewPriority$1_0$0({1}SC:U),B,1,-1
