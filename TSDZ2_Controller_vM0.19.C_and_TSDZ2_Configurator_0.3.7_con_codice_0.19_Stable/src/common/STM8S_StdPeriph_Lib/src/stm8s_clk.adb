...
F:G$CLK_PeripheralClockConfig$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lstm8s_clk.CLK_PeripheralClockConfig$sloc1$0_1$0({1}SC:U),B,1,-4
S:Lstm8s_clk.CLK_PeripheralClockConfig$sloc2$0_1$0({1}SC:U),B,1,-2
S:Lstm8s_clk.CLK_PeripheralClockConfig$sloc3$0_1$0({1}SC:U),B,1,-3
...
S:Lstm8s_clk.CLK_ClockSwitchConfig$clock_master$1_0$0({1}SC:U),R,0,0,[yl]
S:Lstm8s_clk.CLK_ClockSwitchConfig$DownCounter$1_0$0({2}SI:U),R,0,0,[xl,xh]
S:Lstm8s_clk.CLK_ClockSwitchConfig$Swif$1_0$0({1}SC:U),R,0,0,[xl]
...
F:G$CLK_SYSCLKConfig$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_clk.CLK_SYSCLKConfig$CLK_Prescaler$1_0$412({1}SC:U),B,1,2
S:Lstm8s_clk.CLK_SYSCLKConfig$sloc4$0_1$0({1}SC:U),B,1,-2
S:Lstm8s_clk.CLK_SYSCLKConfig$sloc5$0_1$0({1}SC:U),B,1,-1
...
F:G$CLK_GetClockFreq$0_0$0({2}DF,SL:U),Z,0,5,0,0,0
S:Lstm8s_clk.CLK_GetClockFreq$clockfrequency$1_0$0({4}SL:U),B,1,-5
S:Lstm8s_clk.CLK_GetClockFreq$clocksource$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_clk.CLK_GetClockFreq$tmp$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_clk.CLK_GetClockFreq$presc$1_0$0({1}SC:U),R,0,0,[a]
...
S:Lstm8s_clk.CLK_GetFlagStatus$statusreg$1_0$0({2}SI:U),R,0,0,[xl,xh]
S:Lstm8s_clk.CLK_GetFlagStatus$tmpreg$1_0$434({1}SC:U),R,0,0,[a]
S:Lstm8s_clk.CLK_GetFlagStatus$bitstatus$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_clk.CLK_GetFlagStatus$sloc6$0_1$0({1}SC:U),B,1,-1
F:G$CLK_GetITStatus$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstm8s_clk.CLK_GetITStatus$CLK_IT$1_0$442({1}SC:U),B,1,2
S:Lstm8s_clk.CLK_GetITStatus$bitstatus$1_0$0({1}SC:U),R,0,0,[a]
