...
S:Lebike_app.uart_receive_package$ui32_temp$1_0$484({4}SL:U),R,0,0,[xl,xh,yl,yh]
...
S:Lebike_app.uart_receive_package$ui16_temp$3_1$506({2}SI:U),R,0,0,[xl,xh]
S:Lebike_app.uart_receive_package$ui8_temp$3_1$506({1}SC:U),R,0,0,[a]
...
S:Lebike_app.uart_send_package$ui8_i$1_0$508({1}SC:U),R,0,0,[a]
S:Lebike_app.uart_send_package$ui8_tx_check_code$1_0$508({1}SC:U),R,0,0,[yl]
...
S:Lebike_app.ebike_app_set_target_adc_battery_max_current$ui8_value$1_0$527({1}SC:U),B,1,2
F:Febike_app$ebike_app_set_target_adc_motor_max_current$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lebike_app.ebike_app_set_target_adc_motor_max_current$ui8_value$1_0$529({1}SC:U),B,1,2
F:Febike_app$ebike_app_set_battery_max_current$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lebike_app.ebike_app_set_battery_max_current$ui8_value$1_0$531({1}SC:U),B,1,2
F:Febike_app$ebike_app_set_motor_max_current$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lebike_app.ebike_app_set_motor_max_current$ui8_value$1_0$533({1}SC:U),B,1,2
...
S:Lebike_app.calc_pedal_force_and_torque$ui16_pedal_torque_x100$1_0$538({2}SI:U),R,0,0,[xl,xh]
...
S:Lebike_app.calc_motor_temperature$ui16_adc_motor_temperatured_filtered_10b$1_0$547({2}SI:U),R,0,0,[xl,xh]
F:Febike_app$calc_filtered_battery_voltage$0_0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lebike_app.calc_filtered_battery_voltage$ui16_batt_voltage_filtered$1_0$549({2}SI:U),R,0,0,[xl,a]
F:Febike_app$apply_street_mode$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lebike_app.apply_street_mode$ui16_battery_voltage$1_0$550({2}SI:U),B,1,2
S:Lebike_app.apply_street_mode$ui8_max_speed$1_0$550({2}DG,SC:U),B,1,4
S:Lebike_app.apply_street_mode$ui8_target_current$1_0$550({2}DG,SC:U),B,1,6
S:Lebike_app.apply_street_mode$ui8_street_mode_max_current$3_0$553({1}SC:U),R,0,0,[yl]
...
S:Lebike_app.apply_speed_limit$ui16_speed_x10$1_0$554({2}SI:U),B,1,2
S:Lebike_app.apply_speed_limit$ui8_max_speed$1_0$554({1}SC:U),B,1,4
S:Lebike_app.apply_speed_limit$ui8_target_current$1_0$554({2}DG,SC:U),B,1,5
...
S:Lebike_app.apply_walk_assist$ui8_walk_assist_value$1_0$556({1}SC:U),B,1,2
S:Lebike_app.apply_walk_assist$ui8_target_current$1_0$556({2}DG,SC:U),B,1,3
S:Lebike_app.apply_walk_assist$ui8_temp$2_0$558({1}SC:U),R,0,0,[a]
...
S:Lebike_app.apply_temperature_limiting$ui8_target_current$1_0$559({2}DG,SC:U),B,1,2
...
S:Lebike_app.apply_boost$ui8_pas_cadence$1_0$579({1}SC:U),B,1,2
S:Lebike_app.apply_boost$ui8_max_current_boost_state$1_0$579({1}SC:U),B,1,3
S:Lebike_app.apply_boost$ui8_target_current$1_0$579({2}DG,SC:U),B,1,4
S:Lebike_app.apply_boost$ui8_boost_enable$1_0$580({1}SC:U),R,0,0,[xl]
F:Febike_app$apply_boost_fade_out$0_0$0({2}DF,SV:S),Z,0,-2,0,0,0
S:Lebike_app.apply_boost_fade_out$ui8_target_current$1_0$582({2}DG,SC:U),B,1,2
S:Lebike_app.apply_boost_fade_out$ui16_adc_motor_target_current_x256$2_0$584({2}SI:U),B,1,-2
...
S:Lebike_app.torque_sensor_read$ui8_adc_torque_sensor$1_0$593({1}SC:U),R,0,0,[xl]
...
S:Lebike_app.uart_send_package$ui8_overtemperature_counter$3_0$513({1}SC:U),E,0,0
S:Lebike_app.check_system$ui8_motor_blocked_counter$1_0$612({1}SC:U),E,0,0
S:Lebike_app.check_system$ui8_motor_blocked_reset_counter$1_0$612({1}SC:U),E,0,0
