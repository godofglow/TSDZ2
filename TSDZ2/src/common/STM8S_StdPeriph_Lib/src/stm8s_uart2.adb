...
F:G$UART2_Init$0_0$0({2}DF,SV:S),Z,0,9,0,0,0
...
S:Lstm8s_uart2.UART2_Init$BRR2_1$1_0$0({1}SC:U),B,1,-9
S:Lstm8s_uart2.UART2_Init$BRR2_2$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_uart2.UART2_Init$BaudRate_Mantissa$1_0$0({4}SL:U),B,1,-8
S:Lstm8s_uart2.UART2_Init$BaudRate_Mantissa100$1_0$0({4}SL:U),B,1,-4
S:Lstm8s_uart2.UART2_Init$sloc0$0_1$0({4}SL:U),B,1,-31
S:Lstm8s_uart2.UART2_Init$sloc1$0_1$0({4}SL:U),B,1,-35
S:Lstm8s_uart2.UART2_Init$sloc2$0_1$0({4}SL:U),B,1,-18
S:Lstm8s_uart2.UART2_Init$sloc3$0_1$0({4}SL:U),B,1,-26
S:Lstm8s_uart2.UART2_Init$sloc4$0_1$0({4}SL:U),B,1,-14
S:Lstm8s_uart2.UART2_Init$sloc5$0_1$0({4}SL:U),B,1,-22
S:Lstm8s_uart2.UART2_Init$sloc6$0_1$0({1}SC:U),B,1,-10
S:Lstm8s_uart2.UART2_Init$sloc7$0_1$0({1}SC:U),B,1,-27
F:G$UART2_Cmd$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_uart2.UART2_Cmd$NewState$1_0$355({1}SC:U),B,1,2
F:G$UART2_ITConfig$0_0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lstm8s_uart2.UART2_ITConfig$UART2_IT$1_0$359({2}SI:U),B,1,2
S:Lstm8s_uart2.UART2_ITConfig$NewState$1_0$359({1}SC:U),B,1,4
S:Lstm8s_uart2.UART2_ITConfig$uartreg$1_0$0({1}SC:U),R,0,0,[xl]
S:Lstm8s_uart2.UART2_ITConfig$itpos$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_uart2.UART2_ITConfig$sloc8$0_1$0({1}SC:U),B,1,-2
S:Lstm8s_uart2.UART2_ITConfig$sloc9$0_1$0({1}SC:U),B,1,-3
S:Lstm8s_uart2.UART2_ITConfig$sloc10$0_1$0({1}SC:U),B,1,-5
S:Lstm8s_uart2.UART2_ITConfig$sloc11$0_1$0({1}SC:U),B,1,-4
...
S:Lstm8s_uart2.UART2_ReceiveData9$temp$1_0$0({2}SI:U),R,0,0,[xl,xh]
S:Lstm8s_uart2.UART2_ReceiveData9$sloc12$0_1$0({2}SI:U),B,1,-2
...
S:Lstm8s_uart2.UART2_SendData9$sloc13$0_1$0({1}SC:U),B,1,-1
...
F:G$UART2_GetFlagStatus$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstm8s_uart2.UART2_GetFlagStatus$UART2_FLAG$1_0$425({2}SI:U),B,1,2
S:Lstm8s_uart2.UART2_GetFlagStatus$status$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_uart2.UART2_GetFlagStatus$sloc14$0_1$0({1}SC:U),B,1,-4
S:Lstm8s_uart2.UART2_GetFlagStatus$sloc15$0_1$0({1}SC:U),B,1,-3
S:Lstm8s_uart2.UART2_GetFlagStatus$sloc16$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_uart2.UART2_GetFlagStatus$sloc17$0_1$0({1}SC:U),B,1,-2
F:G$UART2_ClearFlag$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_uart2.UART2_ClearFlag$UART2_FLAG$1_0$439({2}SI:U),B,1,2
F:G$UART2_GetITStatus$0_0$0({2}DF,SC:U),Z,0,2,0,0,0
S:Lstm8s_uart2.UART2_GetITStatus$UART2_IT$1_0$445({2}SI:U),B,1,2
S:Lstm8s_uart2.UART2_GetITStatus$pendingbitstatus$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_uart2.UART2_GetITStatus$itpos$1_0$0({1}SC:U),B,1,-2
S:Lstm8s_uart2.UART2_GetITStatus$itmask1$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_uart2.UART2_GetITStatus$itmask2$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_uart2.UART2_GetITStatus$enablestatus$1_0$0({1}SC:U),R,0,0,[xl]
