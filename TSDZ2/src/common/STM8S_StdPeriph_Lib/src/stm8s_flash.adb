...
F:G$FLASH_ProgramWord$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lstm8s_flash.FLASH_ProgramWord$sloc1$0_1$0({2}DG,SC:U),B,1,-6
...
F:G$FLASH_ReadOptionByte$0_0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lstm8s_flash.FLASH_ReadOptionByte$Address$1_0$373({2}SI:U),B,1,2
S:Lstm8s_flash.FLASH_ReadOptionByte$value_optbyte$1_0$0({1}SC:U),R,0,0,[yl]
S:Lstm8s_flash.FLASH_ReadOptionByte$value_optbyte_complement$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_flash.FLASH_ReadOptionByte$res_value$1_0$0({2}SI:U),R,0,0,[xl,yl]
S:Lstm8s_flash.FLASH_ReadOptionByte$sloc3$0_1$0({1}SC:U),B,1,-5
S:Lstm8s_flash.FLASH_ReadOptionByte$sloc4$0_1$0({2}SI:U),B,1,-2
S:Lstm8s_flash.FLASH_ReadOptionByte$sloc5$0_1$0({2}SI:U),B,1,-4
...
F:G$FLASH_GetBootSize$0_0$0({2}DF,SL:U),Z,0,4,0,0,0
S:Lstm8s_flash.FLASH_GetBootSize$temp$1_0$0({4}SL:U),B,1,-4
F:G$FLASH_GetFlagStatus$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstm8s_flash.FLASH_GetFlagStatus$FLASH_FLAG$1_0$390({1}SC:U),B,1,2
S:Lstm8s_flash.FLASH_GetFlagStatus$status$1_0$0({1}SC:U),R,0,0,[a]
...
S:Lstm8s_flash.FLASH_WaitForLastOperation$flagstatus$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_flash.FLASH_WaitForLastOperation$timeout$1_0$0({2}SI:U),R,0,0,[xl,xh]
F:G$FLASH_EraseBlock$0_0$0({2}DF,SV:S),Z,0,4,0,0,0
...
S:Lstm8s_flash.FLASH_EraseBlock$startaddress$1_0$0({4}SL:U),B,1,-4
S:Lstm8s_flash.FLASH_EraseBlock$pwFlash$1_0$0({2}DG,SL:U),R,0,0,[xl,xh]
S:Lstm8s_flash.FLASH_EraseBlock$sloc6$0_1$0({2}SI:U),B,1,-6
F:G$FLASH_ProgramBlock$0_0$0({2}DF,SV:S),Z,0,6,0,0,0
...
S:Lstm8s_flash.FLASH_ProgramBlock$Count$1_0$0({2}SI:U),B,1,-2
S:Lstm8s_flash.FLASH_ProgramBlock$startaddress$1_0$0({4}SL:U),B,1,-6
S:Lstm8s_flash.FLASH_ProgramBlock$sloc7$0_1$0({4}SL:U),B,1,-10
S:Lstm8s_flash.FLASH_ProgramBlock$sloc8$0_1$0({4}SL:U),B,1,-14
S:Lstm8s_flash.FLASH_ProgramBlock$sloc9$0_1$0({2}DG,SC:U),B,1,-16
