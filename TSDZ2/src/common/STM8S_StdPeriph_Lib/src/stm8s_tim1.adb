...
F:G$TIM1_TimeBaseInit$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lstm8s_tim1.TIM1_TimeBaseInit$sloc0$0_1$0({2}SI:U),B,1,-4
S:Lstm8s_tim1.TIM1_TimeBaseInit$sloc1$0_1$0({2}SI:U),B,1,-2
F:G$TIM1_OC1Init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lstm8s_tim1.TIM1_OC1Init$sloc2$0_1$0({1}SC:U),B,1,-5
S:Lstm8s_tim1.TIM1_OC1Init$sloc3$0_1$0({1}SC:U),B,1,-6
S:Lstm8s_tim1.TIM1_OC1Init$sloc4$0_1$0({1}SC:U),B,1,-2
S:Lstm8s_tim1.TIM1_OC1Init$sloc5$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_tim1.TIM1_OC1Init$sloc6$0_1$0({1}SC:U),B,1,-3
S:Lstm8s_tim1.TIM1_OC1Init$sloc7$0_1$0({1}SC:U),B,1,-4
F:G$TIM1_OC2Init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lstm8s_tim1.TIM1_OC2Init$sloc8$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_tim1.TIM1_OC2Init$sloc9$0_1$0({1}SC:U),B,1,-2
S:Lstm8s_tim1.TIM1_OC2Init$sloc10$0_1$0({1}SC:U),B,1,-3
S:Lstm8s_tim1.TIM1_OC2Init$sloc11$0_1$0({1}SC:U),B,1,-4
S:Lstm8s_tim1.TIM1_OC2Init$sloc12$0_1$0({1}SC:U),B,1,-6
S:Lstm8s_tim1.TIM1_OC2Init$sloc13$0_1$0({1}SC:U),B,1,-5
F:G$TIM1_OC3Init$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lstm8s_tim1.TIM1_OC3Init$sloc14$0_1$0({1}SC:U),B,1,-5
S:Lstm8s_tim1.TIM1_OC3Init$sloc15$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_tim1.TIM1_OC3Init$sloc16$0_1$0({1}SC:U),B,1,-3
S:Lstm8s_tim1.TIM1_OC3Init$sloc17$0_1$0({1}SC:U),B,1,-4
S:Lstm8s_tim1.TIM1_OC3Init$sloc18$0_1$0({1}SC:U),B,1,-2
S:Lstm8s_tim1.TIM1_OC3Init$sloc19$0_1$0({1}SC:U),B,1,-6
...
S:Lstm8s_tim1.TIM1_OC4Init$sloc20$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_tim1.TIM1_OC4Init$sloc21$0_1$0({1}SC:U),B,1,-2
...
S:Lstm8s_tim1.TIM1_BDTRConfig$sloc22$0_1$0({1}SC:U),B,1,-1
...
F:G$TIM1_PWMIConfig$0_0$0({2}DF,SV:S),Z,0,2,0,0,0
...
S:Lstm8s_tim1.TIM1_PWMIConfig$icpolarity$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_tim1.TIM1_PWMIConfig$icselection$1_0$0({1}SC:U),B,1,-2
...
S:Lstm8s_tim1.TIM1_ITConfig$sloc23$0_1$0({1}SC:U),B,1,-1
...
S:Lstm8s_tim1.TIM1_ETRConfig$sloc24$0_1$0({1}SC:U),B,1,-1
...
S:Lstm8s_tim1.TIM1_PrescalerConfig$sloc25$0_1$0({2}SI:U),B,1,-2
...
S:Lstm8s_tim1.TIM1_GetCapture1$tmpccr1$1_0$0({2}SI:U),R,0,0,[xl,xh]
S:Lstm8s_tim1.TIM1_GetCapture1$tmpccr1l$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_tim1.TIM1_GetCapture1$tmpccr1h$1_0$0({1}SC:U),R,0,0,[xh]
S:Lstm8s_tim1.TIM1_GetCapture1$sloc32$0_1$0({2}SI:U),B,1,-2
F:G$TIM1_GetCapture2$0_0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lstm8s_tim1.TIM1_GetCapture2$tmpccr2$1_0$0({2}SI:U),R,0,0,[xl,xh]
S:Lstm8s_tim1.TIM1_GetCapture2$tmpccr2l$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_tim1.TIM1_GetCapture2$tmpccr2h$1_0$0({1}SC:U),R,0,0,[xh]
S:Lstm8s_tim1.TIM1_GetCapture2$sloc33$0_1$0({2}SI:U),B,1,-2
F:G$TIM1_GetCapture3$0_0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lstm8s_tim1.TIM1_GetCapture3$tmpccr3$1_0$0({2}SI:U),R,0,0,[xl,xh]
S:Lstm8s_tim1.TIM1_GetCapture3$tmpccr3l$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_tim1.TIM1_GetCapture3$tmpccr3h$1_0$0({1}SC:U),R,0,0,[xh]
S:Lstm8s_tim1.TIM1_GetCapture3$sloc34$0_1$0({2}SI:U),B,1,-2
F:G$TIM1_GetCapture4$0_0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lstm8s_tim1.TIM1_GetCapture4$tmpccr4$1_0$0({2}SI:U),R,0,0,[xl,xh]
S:Lstm8s_tim1.TIM1_GetCapture4$tmpccr4l$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_tim1.TIM1_GetCapture4$tmpccr4h$1_0$0({1}SC:U),R,0,0,[xh]
S:Lstm8s_tim1.TIM1_GetCapture4$sloc35$0_1$0({2}SI:U),B,1,-2
F:G$TIM1_GetCounter$0_0$0({2}DF,SI:U),Z,0,2,0,0,0
S:Lstm8s_tim1.TIM1_GetCounter$tmpcntr$1_0$0({2}SI:U),B,1,-4
S:Lstm8s_tim1.TIM1_GetCounter$sloc36$0_1$0({2}SI:U),B,1,-2
F:G$TIM1_GetPrescaler$0_0$0({2}DF,SI:U),Z,0,2,0,0,0
S:Lstm8s_tim1.TIM1_GetPrescaler$temp$1_0$0({2}SI:U),B,1,-2
S:Lstm8s_tim1.TIM1_GetPrescaler$sloc37$0_1$0({2}SI:U),B,1,-4
F:G$TIM1_GetFlagStatus$0_0$0({2}DF,SC:U),Z,0,2,0,0,0
S:Lstm8s_tim1.TIM1_GetFlagStatus$TIM1_FLAG$1_0$584({2}SI:U),B,1,2
S:Lstm8s_tim1.TIM1_GetFlagStatus$bitstatus$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_tim1.TIM1_GetFlagStatus$tim1_flag_l$1_0$0({1}SC:U),B,1,-2
S:Lstm8s_tim1.TIM1_GetFlagStatus$tim1_flag_h$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_tim1.TIM1_GetFlagStatus$sloc38$0_1$0({1}SC:U),B,1,-3
S:Lstm8s_tim1.TIM1_GetFlagStatus$sloc39$0_1$0({2}SI:U),B,1,-5
F:G$TIM1_ClearFlag$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_tim1.TIM1_ClearFlag$TIM1_FLAG$1_0$588({2}SI:U),B,1,2
F:G$TIM1_GetITStatus$0_0$0({2}DF,SC:U),Z,0,1,0,0,0
S:Lstm8s_tim1.TIM1_GetITStatus$TIM1_IT$1_0$590({1}SC:U),B,1,2
S:Lstm8s_tim1.TIM1_GetITStatus$bitstatus$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_tim1.TIM1_GetITStatus$TIM1_itStatus$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_tim1.TIM1_GetITStatus$TIM1_itEnable$1_0$0({1}SC:U),R,0,0,[a]
...
S:Lstm8s_tim1.TI1_Config$sloc40$0_1$0({1}SC:U),B,1,-1
...
S:Lstm8s_tim1.TI2_Config$sloc41$0_1$0({1}SC:U),B,1,-1
...
S:Lstm8s_tim1.TI3_Config$sloc42$0_1$0({1}SC:U),B,1,-1
...
S:Lstm8s_tim1.TI4_Config$sloc43$0_1$0({1}SC:U),B,1,-1
