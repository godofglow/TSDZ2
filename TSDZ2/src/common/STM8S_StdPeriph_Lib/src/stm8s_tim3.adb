...
S:Lstm8s_tim3.TIM3_OC1Init$sloc1$0_1$0({1}SC:U),B,1,-2
S:Lstm8s_tim3.TIM3_OC1Init$sloc2$0_1$0({1}SC:U),B,1,-1
...
S:Lstm8s_tim3.TIM3_OC2Init$sloc3$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_tim3.TIM3_OC2Init$sloc4$0_1$0({1}SC:U),B,1,-2
...
F:G$TIM3_PWMIConfig$0_0$0({2}DF,SV:S),Z,0,2,0,0,0
...
S:Lstm8s_tim3.TIM3_PWMIConfig$icpolarity$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_tim3.TIM3_PWMIConfig$icselection$1_0$0({1}SC:U),B,1,-2
...
S:Lstm8s_tim3.TIM3_ITConfig$sloc5$0_1$0({1}SC:U),B,1,-1
...
S:Lstm8s_tim3.TIM3_GetCapture1$tmpccr1$1_0$0({2}SI:U),R,0,0,[xl,xh]
S:Lstm8s_tim3.TIM3_GetCapture1$tmpccr1l$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_tim3.TIM3_GetCapture1$tmpccr1h$1_0$0({1}SC:U),R,0,0,[xh]
S:Lstm8s_tim3.TIM3_GetCapture1$sloc10$0_1$0({2}SI:U),B,1,-2
F:G$TIM3_GetCapture2$0_0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lstm8s_tim3.TIM3_GetCapture2$tmpccr2$1_0$0({2}SI:U),R,0,0,[xl,xh]
S:Lstm8s_tim3.TIM3_GetCapture2$tmpccr2l$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_tim3.TIM3_GetCapture2$tmpccr2h$1_0$0({1}SC:U),R,0,0,[xh]
S:Lstm8s_tim3.TIM3_GetCapture2$sloc11$0_1$0({2}SI:U),B,1,-2
F:G$TIM3_GetCounter$0_0$0({2}DF,SI:U),Z,0,2,0,0,0
S:Lstm8s_tim3.TIM3_GetCounter$tmpcntr$1_0$0({2}SI:U),B,1,-4
S:Lstm8s_tim3.TIM3_GetCounter$sloc12$0_1$0({2}SI:U),B,1,-2
...
S:Lstm8s_tim3.TIM3_GetFlagStatus$bitstatus$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_tim3.TIM3_GetFlagStatus$tim3_flag_l$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_tim3.TIM3_GetFlagStatus$tim3_flag_h$1_0$0({1}SC:U),B,1,-2
S:Lstm8s_tim3.TIM3_GetFlagStatus$sloc13$0_1$0({1}SC:U),B,1,-3
S:Lstm8s_tim3.TIM3_GetFlagStatus$sloc14$0_1$0({2}SI:U),B,1,-5
F:G$TIM3_ClearFlag$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_tim3.TIM3_ClearFlag$TIM3_FLAG$1_0$451({2}SI:U),B,1,2
F:G$TIM3_GetITStatus$0_0$0({2}DF,SC:U),Z,0,1,0,0,0
S:Lstm8s_tim3.TIM3_GetITStatus$TIM3_IT$1_0$453({1}SC:U),B,1,2
S:Lstm8s_tim3.TIM3_GetITStatus$bitstatus$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_tim3.TIM3_GetITStatus$TIM3_itStatus$1_0$0({1}SC:U),B,1,-1
S:Lstm8s_tim3.TIM3_GetITStatus$TIM3_itEnable$1_0$0({1}SC:U),R,0,0,[a]
...
S:Lstm8s_tim3.TI1_Config$sloc15$0_1$0({1}SC:U),B,1,-1
...
S:Lstm8s_tim3.TI2_Config$sloc16$0_1$0({1}SC:U),B,1,-1
