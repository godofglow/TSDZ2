...
F:G$ADC1_SchmittTriggerConfig$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lstm8s_adc1.ADC1_SchmittTriggerConfig$sloc1$0_1$0({1}SC:U),B,1,-2
S:Lstm8s_adc1.ADC1_SchmittTriggerConfig$sloc2$0_1$0({1}SC:U),B,1,-3
S:Lstm8s_adc1.ADC1_SchmittTriggerConfig$sloc3$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_adc1.ADC1_SchmittTriggerConfig$sloc4$0_1$0({1}SC:U),B,1,-4
...
F:G$ADC1_GetConversionValue$0_0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lstm8s_adc1.ADC1_GetConversionValue$temph$1_0$0({2}SI:U),R,0,0,[yl,yh]
S:Lstm8s_adc1.ADC1_GetConversionValue$templ$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_adc1.ADC1_GetConversionValue$sloc5$0_1$0({2}SI:U),B,1,-8
S:Lstm8s_adc1.ADC1_GetConversionValue$sloc6$0_1$0({2}SI:U),B,1,-2
S:Lstm8s_adc1.ADC1_GetConversionValue$sloc7$0_1$0({2}SI:U),B,1,-4
S:Lstm8s_adc1.ADC1_GetConversionValue$sloc8$0_1$0({2}SI:U),B,1,-6
F:G$ADC1_AWDChannelConfig$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lstm8s_adc1.ADC1_AWDChannelConfig$sloc9$0_1$0({1}SC:U),B,1,-2
S:Lstm8s_adc1.ADC1_AWDChannelConfig$sloc10$0_1$0({1}SC:U),B,1,-3
S:Lstm8s_adc1.ADC1_AWDChannelConfig$sloc11$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_adc1.ADC1_AWDChannelConfig$sloc12$0_1$0({1}SC:U),B,1,-4
...
F:G$ADC1_GetBufferValue$0_0$0({2}DF,SI:U),Z,0,0,0,0,0
S:Lstm8s_adc1.ADC1_GetBufferValue$Buffer$1_0$404({1}SC:U),B,1,2
S:Lstm8s_adc1.ADC1_GetBufferValue$temph$1_0$0({2}SI:U),R,0,0,[yl,yh]
S:Lstm8s_adc1.ADC1_GetBufferValue$templ$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_adc1.ADC1_GetBufferValue$sloc13$0_1$0({2}SI:U),B,1,-4
S:Lstm8s_adc1.ADC1_GetBufferValue$sloc14$0_1$0({2}SI:U),B,1,-6
S:Lstm8s_adc1.ADC1_GetBufferValue$sloc15$0_1$0({2}SI:U),B,1,-2
S:Lstm8s_adc1.ADC1_GetBufferValue$sloc16$0_1$0({2}SI:U),B,1,-8
F:G$ADC1_GetAWDChannelStatus$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstm8s_adc1.ADC1_GetAWDChannelStatus$Channel$1_0$408({1}SC:U),B,1,2
S:Lstm8s_adc1.ADC1_GetAWDChannelStatus$status$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_adc1.ADC1_GetAWDChannelStatus$sloc17$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_adc1.ADC1_GetAWDChannelStatus$sloc18$0_1$0({1}SC:U),B,1,-2
F:G$ADC1_GetFlagStatus$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstm8s_adc1.ADC1_GetFlagStatus$Flag$1_0$412({1}SC:U),B,1,2
S:Lstm8s_adc1.ADC1_GetFlagStatus$flagstatus$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_adc1.ADC1_GetFlagStatus$temp$1_0$0({1}SC:U),R,0,0,[xl]
S:Lstm8s_adc1.ADC1_GetFlagStatus$sloc19$0_1$0({2}SI:S),B,1,-2
S:Lstm8s_adc1.ADC1_GetFlagStatus$sloc20$0_1$0({1}SC:U),B,1,-4
S:Lstm8s_adc1.ADC1_GetFlagStatus$sloc21$0_1$0({1}SC:U),B,1,-3
F:G$ADC1_ClearFlag$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_adc1.ADC1_ClearFlag$Flag$1_0$419({1}SC:U),B,1,2
S:Lstm8s_adc1.ADC1_ClearFlag$temp$1_0$0({1}SC:U),R,0,0,[xl]
S:Lstm8s_adc1.ADC1_ClearFlag$sloc22$0_1$0({2}SI:S),B,1,-2
S:Lstm8s_adc1.ADC1_ClearFlag$sloc23$0_1$0({1}SC:U),B,1,-3
S:Lstm8s_adc1.ADC1_ClearFlag$sloc24$0_1$0({1}SC:U),B,1,-4
S:Lstm8s_adc1.ADC1_ClearFlag$sloc25$0_1$0({1}SC:U),B,1,-5
F:G$ADC1_GetITStatus$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstm8s_adc1.ADC1_GetITStatus$ITPendingBit$1_0$426({2}SI:U),B,1,2
S:Lstm8s_adc1.ADC1_GetITStatus$itstatus$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_adc1.ADC1_GetITStatus$temp$1_0$0({1}SC:U),R,0,0,[xl]
S:Lstm8s_adc1.ADC1_GetITStatus$sloc26$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_adc1.ADC1_GetITStatus$sloc27$0_1$0({1}SC:U),B,1,-2
S:Lstm8s_adc1.ADC1_GetITStatus$sloc28$0_1$0({1}SC:U),B,1,-3
F:G$ADC1_ClearITPendingBit$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstm8s_adc1.ADC1_ClearITPendingBit$ITPendingBit$1_0$432({2}SI:U),B,1,2
S:Lstm8s_adc1.ADC1_ClearITPendingBit$temp$1_0$0({1}SC:U),R,0,0,[xl]
S:Lstm8s_adc1.ADC1_ClearITPendingBit$sloc29$0_1$0({1}SC:U),B,1,-1
S:Lstm8s_adc1.ADC1_ClearITPendingBit$sloc30$0_1$0({1}SC:U),B,1,-2
